...
contract Hub is OwnedHub, Math {
  ...
  // -----------------------
  // To be called manually as a managed op to change the Sale contract in OpMan, here and in the Poll contract, plus change the Sale owner for Hub, Token, List, Mfund, Pfund
