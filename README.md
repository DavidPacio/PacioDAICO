...
Hub       Hub or management contract                                 OpMan, Admin, Sale          OpMan; Sale; Token; List; Escrow; Grey; VoteTap; VoteEnd; MvpLaunch
Sale      Sale                                                       OpMan, Hub                  OpMan; Hub -> Token,List,Escrow,Grey,VoteTap,VoteEnd,MvpLaunch; List; Token -> List; Escrow; Grey
Token     Token contract with EIP-20 functions                       OpMan, Hub, Sale, MvpLaunch OpMan; List
...
MvpLaunch Re MVP launch and transferring PIOEs to PIOs               OpMan, Hub                  OpMan; Token -> List
